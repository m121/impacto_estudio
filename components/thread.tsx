...
import {
  ...
  CHAT_WELCOME_SUGGESTIONS,
  CHAT_WELCOME_TITLE,
} from "@/lib/constants";
import type { ChatWelcomeSuggestion } from "@/lib/types";
...
const ImpactoWelcomeSuggestion: FC<{ suggestion: ChatWelcomeSuggestion }> = ({
  suggestion,
}) => {
  const aui = useAui();
