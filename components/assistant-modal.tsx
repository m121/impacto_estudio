...
>(({ "data-state": state, ...rest }, ref) => {
  const tooltip = state === "open" ? "Cerrar chat" : "Abrir asistente";
  ...
  return (
    <TooltipIconButton
      ...
      side="left"
      {...rest}
      className="aui-modal-button size-full rounded-full bg-[#F84677] text-white shadow-lg shadow-[#F84677]/35 transition-transform hover:scale-110 hover:brightness-110 active:scale-90"
      ref={ref}
    >
      <BotIcon
        data-state={state}
